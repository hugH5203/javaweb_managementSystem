...
<div class="container">
    ...
    <div style="float: left;">
        ...
        <form class="form-inline" action="${pageContext.request.contextPath}/moHuServlet" method="post">
            <div class="form-group">
                <label for="exampleInputName2">姓名</label>
                <input name="username" type="text" class="form-control" id="exampleInputName2" placeholder="输入姓名或关键字">
            </div>
    ...
    <div>
        <nav aria-label="Page navigation">
            <ul class="pagination">
                <a href="${pageContext.request.contextPath}/findByPageServlet?currentPage=1&rows=8" >首页</a>
                ...
                <c:forEach begin="1" end="${pb.totalPage}" var="i">
                    ...
                    <a href="${pageContext.request.contextPath}/findByPageServlet?currentPage=${pb.totalPage}&rows=8" >尾页</a>
