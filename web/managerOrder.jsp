                    ...
                    <div class="time-title ">
                        <div class="year-month pull-left">
                            <div class="container">
                                ...
                                <table style="color: #1D2024" border="1" class="table table-bordered table-hover">
                                    <tr class="success">
                                        <th>编号</th>
                                        <th>书名</th>
                                        <th>作者</th>
                                    ...
                                    <c:forEach items="${books}" var="book" varStatus="b">
                                        <tr>
                                            ...
                                            <td>${book.pubdate}</td>
                                            <td>${book.booktype}</td>
                                            <td><a class="btn btn-default btn-sm" href="${pageContext.request.contextPath}/deleteOrderServlet?id=${book.bookid}">删除订单</a>
                                            <a onclick="buy(this)" class="btn btn-default btn-sm" href="${pageContext.request.contextPath}/buyCode.html">支付订单</a>
                                        </tr>
                                    </c:forEach>
                                </table>
                            </div>
