...
<div class="down-main">
    ...
    <div class="container">
        <h3 style="text-align: center">可购图书列表</h3>
        ...
        <div style="float: left;">
            ...
            <form class="form-inline" action="#" method="post">
                <div class="form-group">
                    ...
                    <input name="username" type="text" class="form-control" id="exampleInputName2" placeholder="输入书名或关键字">
                </div>
        ...
        <div style="float: right;margin: 5px;">
            <a class="btn btn-primary" href="#">添加图书</a>
        </div>
                ...
                <c:forEach items="${books}" var="book" varStatus="b">
                    <tr>
                        ...
                        <td><a class="btn btn-default btn-sm"
                               href="${pageContext.request.contextPath}/buyBookServlet?id=${book.bookid}">加入购物车</a>
                    </tr>
                </c:forEach>
            </table>
</div>
