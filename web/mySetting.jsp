            ...
            <div class="info-center">
                ...
                <div class="indentify-class padding-lr">
                    <p class="margin-big-tb text-sub text-default">
                        请选择设置类型，该设置仅为个人账号设置，不会影响其他管理员使用
                    </p>
                    <ul class="class-content">
                        <li class="pull-left margin-large-35">
                            <a class="class-detail pull-right " href="${pageContext.request.contextPath}/updatePassword.jsp">
                                <div class="class-detail-top">
                                    <div class="text-center indentify-icon">
                                        <img src="img/identify_personal.png">
                                    </div>
                                    <h3 class="text-center">更换密码</h3>
                                    <p class="margin-tb padding-bottom text-justify info">
                                        密码更换后需重新登录
                                    </p>
                                    <ul class="class-detail-has margin-top text-lh-big">
                                        <li>
                                            <span class="text-black-gray">密码安全性</span>
                                            <span class="pull-right text-gray-white" style="color: red">低</span>
                                        </li>
                                        <li>
                                            <span class="text-black-gray">登录地区</span>
                                            <span class="pull-right text-gray-white" style="color: #1c78de">中国湖北</span>
                                        </li>
                                        <li>
                                            <span class="text-black-gray">账号认证</span>
                                            <span class="pull-right text-gray-white" style="color: #4cae4c">管理员</span>
                                        </li>
                                    </ul>
                                </div>
                        ...
                        <li class="pull-left margin-large-35">
                            <a class="class-detail pull-right " href="${pageContext.request.contextPath}/updateUsername.jsp">
                                <div class="class-detail-top">
                                    <div class="text-center indentify-icon">
                                        <img src="img/identify_enterprise.png">
                                    </div>
                                    <h3 class="text-center">修改昵称</h3>
                                    <p class="margin-tb padding-bottom text-justify info">
                                        昵称修改后需重新登录
                                    </p>
                                    <ul class="class-detail-has margin-top text-lh-big">
                                        <li>
                                            <span class="text-black-gray">昵称重复率</span>
                                            <span class="pull-right text-gray-white" style="color: red">高</span>
                                        </li>
                                        <li>
                                            <span class="text-black-gray">登录地区</span>
                                            <span class="pull-right text-gray-white" style="color: #1c78de">中国湖北</span>
                        ...
                        <li class="pull-left margin-large-35">
                            <a class="class-detail pull-right " href="${pageContext.request.contextPath}/loginServlet">
                                <div class="class-detail-top">
                                    <div class="text-center indentify-icon">
                                        <img src="img/identify_developer.png">
                                    </div>
                                    <h3 class="text-center">换账号</h3>
                                    <p class="margin-tb padding-bottom text-justify info">
                                        需重新登录
                                    </p>
                                    <ul class="class-detail-has margin-top text-lh-big">
                                        <li>
                                            <span class="text-black-gray">账号安全性</span>
                                            <span class="pull-right text-gray-white" style="color: red">高</span>
                                        </li>
                                        <li>
                                            <span class="text-black-gray">登录地区</span>
                        ...
                        <li class="pull-left margin-large-35">
                            <a class="class-detail pull-right " href="${pageContext.request.contextPath}/loginServlet">
                                <div class="class-detail-top">
                                    ...
                                    <ul class="class-detail-has margin-top text-lh-big">
                                        <li>
                                            <span class="text-black-gray">账号状态</span>
                                            <span class="pull-right text-gray-white" style="color: red">在线</span>
                                        </li>
                                        <li>
                                            <span class="text-black-gray">登录地区</span>
                                            <span class="pull-right text-gray-white" style="color: #1c78de">中国湖北</span>
