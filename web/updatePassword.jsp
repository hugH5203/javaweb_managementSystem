...
<div class="down-main">
    ...
    <div class="container" style="width: 400px;">
        <h3 style="text-align: center;">更换密码</h3>
        <form action="${pageContext.request.contextPath}/updatePasswordServlet" method="post"  onsubmit="return check()">
            <div class="form-group">
                <label for="name">昵称：</label>
                <input type="text" class="form-control" id="name" name="name" value="${manager.username}" readonly="readonly" placeholder="请输入昵称" />
            </div>

            <div class="form-group">
                <label for="oldPassword">原密码：</label>
                <input type="text" class="form-control" id="oldPassword" name="oldPassword" value="" placeholder="请输入原密码" />
            </div>

            <div class="form-group">
                <label for="newPassword1">新密码：</label>
                <input type="text" class="form-control" id="newPassword1"  name="newPassword1"  value="" placeholder="请输入新密码" />
            </div>
            <div class="form-group">
                <label for="newPassword2">确认新密码：</label>
                <input type="text" class="form-control" id="newPassword2"  name="newPassword2"  value="" placeholder="请确认新密码" />
            </div>
...
<script type="text/javascript">
    function check() {
        ...
        if (parseInt(oldPassword)!=${manager.password} || age==""){
            alert("原密码不正确！")
            return false;
        }
